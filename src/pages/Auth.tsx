        ...
        <CardContent>
          ...
          <div className="mb-6">
            <Button
              ...
              className="w-full bg-primary hover:bg-primary/90 text-white font-medium py-6 rounded-xl flex items-center justify-center gap-3 shadow-lg transition-all"
            >
              <svg
                className="w-6 h-6"
                viewBox="0 0 24 24"
